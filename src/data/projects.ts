...
export const projects: Project[] = [
  {
    ...
    category: "UX PROJECT",
    shortDesc:
      "Solo UX project — designed a health and wellness app from empathy mapping through to an interactive Figma prototype.",
    longDesc:
    ...
    image: healthAppImg,
    links: [
      { label: "View prototype", url: "https://www.figma.com/proto/aOfhdCWcCwQ6GXwmK1gE7k/Untitled?node-id=1-2&viewport=628%2C82%2C0.94&t=tDE5v0ztQ2VRHeg3-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1" },
    ],
  },
  {
    id: "toy-library",
  ...
  },
  {
    ...
    category: "UX PROJECT",
    shortDesc:
      "Group project — UX design for a luggage rental service aimed at travellers who want to move freely.",
    longDesc:
      "A collaborative UX design project for a luggage rental concept. As a team we went through the full process: research, empathy mapping, personas, journey mapping, wireframes, and a polished interactive Figma prototype.",
    tags: ["Figma", "User Research", "Prototyping", "Group Project", "FigJam"],
    deliverables: [
      "Empathy map",
      "User persona",
